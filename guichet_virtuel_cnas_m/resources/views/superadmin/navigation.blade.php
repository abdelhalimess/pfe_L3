@section('navigation_bar')
    ...
    <ul class="pcoded-item pcoded-left-item">
        <li
            class="pcoded-hasmenu {{ \Request::route()->getName() == 'users-list' || \Request::route()->getName() == 'create-user' ? 'pcoded-trigger' : '' }}">
            <a href="javascript:void(0)">
        ...
        <li
            class="pcoded-hasmenu {{ \Request::route()->getName() == 'structures-list' || \Request::route()->getName() == 'structuretypes-list' ? 'pcoded-trigger' : '' }}">
            <a href="javascript:void(0)">
        ...
        <li
            class="pcoded-hasmenu {{ \Request::route()->getName() == 'roles-list' || \Request::route()->getName() == 'permissions-list' ? 'pcoded-trigger' : '' }}">
            <a href="javascript:void(0)">
        ...
        <li
            class="pcoded-hasmenu {{ \Request::route()->getName() == 'states-list' || \Request::route()->getName() == 'communes-list' ? 'pcoded-trigger' : '' }}">
            <a href="javascript:void(0)">
        ...
        <li
            class="pcoded-hasmenu {{ \Request::route()->getName() == 'services-list' || \Request::route()->getName() == 'questions-list' ? 'pcoded-trigger' : '' }}">
            <a href="javascript:void(0)">
