...
<li class="breadcrumb-item">
    <a href="{{ route('workresumptions.index') }}">Liste des déclarations</a>
</li>
@endsection
{{-- <style>
    .table tbody td {
...
<div class="row ">
    ...
    <div class="modal fade" id="workresumption-modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content" >
                ...
                <div class="modal-body">
                    <form>
                        <div class="row" id="add-workresumption-form">

                            <div class="form-group col-md-12 m-t-15">
                                <label for="-date" class="block">Agent CNAS <span class="text-danger">
                                        (*)</span></label>
                                <div :class="[errors.agent_id ? '  input-group input-group-danger' : '  input-group input-group-inverse']"
                            ...
                            <div class="form-group col-md-12 ">
                                <label for="leave_date" class="block">Date de sortie<span class="text-danger">
                                        (*)</span></label>
                                <div
                                    :class="[errors.leave_date ? ' input-group input-group-danger' : ' input-group input-group-inverse']">
                            ...
                            <div class="form-group col-md-6">
                                <label for="leave_time" class="block">Heure départ<span class="text-danger">
                                        (*)</span></label>
                                <div
                                    :class="[errors.leave_time ? ' input-group input-group-danger' : ' input-group input-group-inverse']">
                            ...
                            <div class="form-group col-md-6">
                                <label for="return_time" class="block">Heure de retour<span class="text-danger">
                                        (*)</span></label>
                                <div
                                    :class="[errors.return_time ? ' input-group input-group-danger' : ' input-group input-group-inverse']">
                                    <div class='input-group'>
                            ...
                            <div class="form-group col-md-6">
                                <label for="leave_reason" class="block">Motif <span class="text-danger">
                                        (*)</span></label>
                                <div :class="[errors.leave_reason ? '  input-group input-group-danger' : '  input-group input-group-inverse']"
                            ...
                            <div class="form-group col-md-6 " v-if="reason == 'RS' ">
                                ...
                                <div :class="[errors.details ? '  input-group input-group-danger' : '  input-group input-group-inverse']"
                                    ...
                                    <input id="details" type="text" class="form-control "
                                        ...
                                        data-placement="top" v-model='details'
                                        :data-original-title="errors.details">
                                    <span class="input-group-addon">
                                        <i class="icofont icofont-id-card"></i>
                                    </span>
                                </div>
                ...
                <div class="modal-footer">
                    <button v-if="operation=='add'" type="button" class="btn btn-primary waves-effect waves-light "
                        v-on:click="add_workresumption()">Sauvguarder</button>
                    <button v-if="operation=='edit'" type="button" class="btn btn-primary waves-effect waves-light "
                        v-on:click="update_workresumption()">Sauvguarder</button>
    ...
    <div class="col-lg-12 col-xl-12 col-md-12">
        ...
        <div class="card " style="overflow-x:hidden;">
            <div class="card-header table-card-header">
                <h5><i class="icofont icofont-list m-r-5"></i>Liste des déclarations</h5>
                <div class="card-header-right">
                    <ul class="list-unstyled card-option">
                        ...
                        clearInputs()">
                            <span data-toggle="modal" data-target="#workresumption-modal">
                                <i class="fa fa-plus faa-horizontal animated text-success " data-toggle="tooltip"
                                    ...
                                    style="font-size:22px" v-on:click="operation='add';
                                    clearInputs()">
                                </i>
                            </span>
                        </li>
            ...
            <div class="card-block ">
                <div class="dt-responsive table-responsive ">
                    <table id="workresumptions-table" class="table table-bordered dataex-colvis-exclude "
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">DATE CESSE TRAVAIL</th>
                                <th class="text-center">DATE REPRISE</th>
                                <th class="text-center">DATE NON REPRISE</th>
                                <th class="text-center">MOTIF - OBJET DEPLACEMENT</th>
                            </tr>
                        </thead>
                        <tbody class="">
                            <tr v-for="(workresumption, index) in workresumptions">
                                ...
                                <td class="text-center ">
                                    <div class="dropdown-secondary dropdown ">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdown11"
                                            ...
                                            <a data-toggle="modal" data-target="#workresumption-modal"
                                                class="dropdown-item waves-light waves-effect clickable"
                                                v-on:click="edit_workresumption(workresumption,index)"><i
                                                    class="icofont icofont-ui-edit f-18"></i> Modifier</a>
                                            {{-- <a class="dropdown-item waves-light waves-effect clickable" v-on:click="print_workresumption_fr(workresumption)"><i --}}
                                            <a class="dropdown-item waves-light waves-effect clickable"
                                                v-on:click="print_workresumption_fr(workresumption)"
                                                {{-- data-toggle="modal" data-target="#workresumption-preview"><i --}}>
                                                <i class="icofont icofont-print f-18"></i> Imprimer</a>
                                            {{-- <a class="dropdown-item waves-light waves-effect clickable" v-on:click="calculate_fees(workresumption);"><i
                                            ...
                                            <a class="dropdown-item waves-light waves-effect clickable text-danger"
                                                v-on:click="delete_workresumption(workresumption.id,index)"><i
                                ...
                                <td class="text-center " style="width:auto;vertical-align:middle">
                                    @{{ workresumption.agent.firstname.toUpperCase() + ' ' +workresumption.agent.lastname.toUpperCase()}}

                                </td>

                                <td class="text-center " style="width:auto;vertical-align:middle">
                                    @{{ workresumption.responsable.fullname.toUpperCase() }}

                                </td>
                                <td class="text-center " style="vertical-align:middle">
                                    @{{ reFormatDate(workresumption.leave_date) }}
                                </td>
                                <td class="text-center " style="vertical-align:middle">
                                    @{{ reFormatTime(workresumption.leave_time) }}
                                </td>

                                <td class="text-center " style="vertical-align:middle">
                                    @{{ reFormatTime(workresumption.return_time) }}
                                </td>

                                <td class="text-center " style="vertical-align:middle" v-if="workresumption.details">
                                    @{{ workresumption.reason + ' - ' + workresumption.details  }}</td>
                                <td class="text-center " style="vertical-align:middle" v-else>
                                    @{{ workresumption.reason   }}</td>
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                modal_title: '',
                selectedworkresumptionId: '',
                selectedworkresumptionIndex: '',
                notifications: [],
        ...
        mounted() {
            $(document).ready(function () {
                ...
                $('#refresh').on('click', function () {
                    ...
                    $('#demo').val("");
                    $("#workresumptions-table").DataTable().search("").draw();
                ...
                $('#demo').on("change", function () {
                    ...
                    $('#workresumptions-table').DataTable().draw();
                ...
                $('#f-motif').on("change", function () {
                    ...
                    var val = $.fn.dataTable.util.escapeRegex(
                            ...
                            $("#workresumptions-table").DataTable().columns([7])
            ...
            $('#files').filer({
                ...
                captions: {
                    ...
                    feedback: "Demande d'ordre de workresumption...",
            ...
            $('#files_').filer({
                ...
                captions: {
                    button: "<span class='icofont icofont-file-pdf'> </span>",
                    feedback: "Rapport de workresumption...",
                    feedback2: "Fichier sélectionné &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp" +
                        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",
            ...
            this.fill_table('/getworkresumptions', 'workresumptions-table');

            $('.date').daterangepicker({
                singleDatePicker: true,
                showDropdowns: true,
                "timePicker": false,
                "parentEl": "#workresumption-modal",
                "opens": "right",
                "locale": {
                    "format": "DD/MM/YYYY",
                    "daysOfWeek": [
        ...
        methods: {
            ...
            calculate_fees(workresumption) { //check error when more than 1 day (number of meals...)
                // console.log(workresumption.destinations.map(d =>d.id));
                var app = this;
                if (workresumption.leave_time && workresumption.return_time && workresumption.leave_date &&
                    workresumption.ended_at && workresumption.transportation && workresumption.reason && workresumption.source &&
                    workresumption.destinations) {
                    app.maxDistance = 0;
                    ...
                    switch (workresumption.transportation.slice(0, 2)) {
                        case 'AU':
                            app.km_fees = 3;
                            km_top_position = 126;
                            break;
                    ...
                    axios.post('/getDistances/', {
                        'source_id': workresumption.source_id,
                        'destinations_ids': workresumption.destinations.map(d => d.id),
                        'grade_id': workresumption.agent.fonction.grade_id
                    }).then(function (response) {
                        if (response.data.error) {
                            // app.workresumptions.splice(index,1)
                            ...
                            if (app.maxDistance < 30) {
                                ...
                                app.dates = getDates(workresumption.leave_date, workresumption.ended_at);
                                ...
                                if (app.dates.length < 2) { // same day
                                    let timeSegments = [];
                                    timeSegments.push([workresumption.leave_time, workresumption.return_time]);
                                    ...
                                    console.log(workresumption.leave_time, app.food_allowance_intervals[1][
                                            1], workresumption.leave_time <= app
                                        .food_allowance_intervals[1][1]);

                                    var da = [];
                                    da.push(app.dates[0], app.dates[app.dates.length - 1]);

                                    if (workresumption.leave_time < app.food_allowance_intervals[0][1]) {
                                        app.meals += 2;

                                    }
                                    // else  if (workresumption.leave_time <= food_allowance_intervals[1][0]){
                                    //     meals += 1; 

                                    // } 
                                    else if (workresumption.leave_time < app.food_allowance_intervals[1][
                                        1]) {
                                        app.meals += 1;
                                    ...
                                    if (workresumption.return_time <= app.food_allowance_intervals[0][
                                        0]) { // <= 11:00
                                        app.meals += 0;
                                    } else if (workresumption.return_time <= app.food_allowance_intervals[1][
                                        0]) { // <= 18:00
                                        app.meals += 1;
                                    } else if (moment(app.food_allowance_intervals[2][0], 'HH:mm').diff(
                                            moment(workresumption.return_time, 'HH:mm')) < 0) { // <= 00:00
                                        app.meals += 2;
                                    }
                        ...
                        axios.put('/updateDecompte/' + workresumption.id, {
                            ...
                            .then(function (response) {
                                ...
                                notify('Succès', response.data.success, 'green', 'topCenter',
                                    'bounceInDown');
                                app.fill_table('/getworkresumptions', 'workresumptions-table');
                        ...
                        swal({
                            ...
                            function (isConfirm) {
                                if (isConfirm) {
                                    app.print_decompte_fr(workresumption);
            ...
            print_decompte_fr(workresumption) {
                var doc = new jsPDF();
                ...
                doc.text(workresumption.agent.firstname + ' ' + workresumption.agent.lastname, 92, 42);
                doc.text(workresumption.agent.fonction.name.toUpperCase(), 62, 48);
                doc.text(workresumption.source.name.toUpperCase(), 87, 54);
                doc.text(workresumption.reason.toUpperCase(), 82, 60);
                doc.text(workresumption.destinations.map(d => d.name).toString().toUpperCase(), 81, 66);
                doc.text(reFormatDate(workresumption.leave_date) + '    à    ' + reFormatTime(workresumption.leave_time),
                    85, 72);
                doc.text(reFormatDate(workresumption.ended_at) + '    à    ' + reFormatTime(workresumption.return_time), 85,
                    78);
                doc.text(workresumption.transportation, 92, 84);
            ...
            print_workresumption_fr(workresumption) {

                this.selected_workresumption = workresumption;
                var doc = new jsPDF();
                // var doc = new jsPDF("p", "mm", "a4");
                new jsPDF('p', 'mm', [210, 133]);
                doc.setFontSize(10);
                ...
                doc.text(workresumption.agent.firstname, 59, 59.5);
                doc.text(workresumption.agent.lastname, 119, 59.5);
                doc.text(workresumption.agent.fonction.name, 65, 66.2);
               

                
                if(workresumption.reason == 'AP') {
                    doc.text('_____________________________________________', 48, 105.5);
                } else if(workresumption.reason == 'RS'){
                    doc.text('______________________', 48.5, 100.5);
                }
                
                // doc.text(workresumption.agent.fullname, 65, 123); 
                var date = reFormatDate(workresumption.leave_date).split('/');
                console.log(date);
                
                
                console.log(hashCode( workresumption.responsable.fullname+' - '+ reFormatDate(new Date())));
                ...
                doc.text(reFormatTime(workresumption.leave_time), 77.5, 80.7);
               if(workresumption.return_time) doc.text(reFormatTime(workresumption.return_time), 128.5, 80.7);
                doc.setFontSize(10);
                // doc.text(workresumption.agent.transportation, 65, 154);
                if (workresumption.details) {
                    doc.text(workresumption.details, 51.5, 113.5);
                }
                // doc.text(workresumption.agent.fullname, 65, 169);
            ...
            calculate_fees_for_all() {
                var app = this;
                app.workresumptions.map(function (workresumption) {

                    if (workresumption.leave_time && workresumption.return_time && workresumption.leave_date &&
                        workresumption.ended_at && workresumption.transportation && workresumption.reason && workresumption
                        .source &&
                        workresumption.destinations) {
                        app.maxDistance = 0;
                        app.km_fees = 0; // (0, 3, 12)
                        ...
                        axios.post('/getDistances/', {
                            ...
                            if (response.data.error) {
                                ...
                                if (app.maxDistance < 30) {
                                    ...
                                    app.dates = getDates(workresumption.leave_date, workresumption
                                    .ended_at);
                                    // meals = dates.length *2;
                                    // nights = dates.length;
                                    app.km_total = (app.maxDistance * app.km_fees) * 2;
                                    ...
                                    if (app.dates.length < 2) { // same day
                                        let timeSegments = [];
                                        timeSegments.push([workresumption.leave_time, workresumption
                                            .return_time
                                        ]);
                                        timeSegments.push(app.food_allowance_intervals[0]);
                                        console.log(overlap(timeSegments)); // true
                                        ...
                                        console.log(workresumption.leave_time, app
                                            .food_allowance_intervals[1][1], workresumption
                                        ...
                                        if (workresumption.leave_time < app
                                        ...
                                        // } 
                                        else if (workresumption.leave_time < app
                                            .food_allowance_intervals[1][1]) {
                                            app.meals += 1;
                                        ...
                                        console.log('meals of start', app.meals);
                                        if (workresumption.return_time <= app.food_allowance_intervals[
                                                0][0]) { // <= 11:00
                                            app.meals += 0;
                                        } else if (workresumption.return_time <= app
                                            .food_allowance_intervals[1][0]) { // <= 18:00
                                            app.meals += 1;
                                        } else if (moment(app.food_allowance_intervals[2][0],
                                                'HH:mm').diff(moment(workresumption.return_time,
                                                'HH:mm')) < 0) { // <= 00:00
                                            app.meals += 2;
                                        }
                                        app.nights += (app.dates.length - 2) + 1;
            ...
            clearInputs() {
                ...
                this.selectedworkresumptionId = '';
                this.selectedworkresumptionIndex = '';
            },
                ...
                new $.fn.dataTable.Responsive($('#' + tableName).DataTable({
                    ...
                    initComplete: function () {
                        ...
                        $('#f-agents').selectpicker('refresh').on('change', function () {
                            ...
                            $("#workresumptions-table").DataTable().columns([2])
                        ...
                        this.api().columns([3]).every(function () {
                            ...
                            column.data().unique().sort().each(function (d, j) {
                                $('#f-responsables').append('<option value="' + d +
                                    '">' +
                                    d + '</option>')
                            });
                        });
                        ...
                        $('#f-responsables').selectpicker('refresh').on('change', function () {
                            ...
                            $("#workresumptions-table").DataTable().columns([3])
                                .search(val ? '^' + val + '$' : '', true, false)
                                .draw();
                        });
            ...
            fill_table(url, tableName) {
                var app = this;
                this.fetch_workresumptions(url, tableName).then((response) => {
                    app.init_table(tableName);
                    app.unblock(tableName);
                });
            },
            fetch_workresumptions(url, tableName) {
                var app = this;
                app.block(tableName);
                $('#' + tableName).DataTable().destroy();
                return axios.get(url)
                    .then(function (response) {
                        app.workresumptions = response.data.leave_docs;
                    })
                    .catch();
            },
            delete_workresumption(id, index) {
                swal({
                        title: "Êtes-vous sûr?",
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            axios.delete('/workresumptions/' + id)
                                .then(function (response) {
                                    if (response.data.error) {
                                        // app.workresumptions.splice(index,1)
                                        notify('Erreur', response.data.error, 'red', 'topCenter',
            ...
            edit_workresumption(workresumption, index) {
                var app = this;
                app.selectedworkresumptionId = workresumption.id;
                app.selectedworkresumptionIndex = index;
                app.operation = 'edit';
                app.modal_title = "Modifier un bon de sortie";
                app.agent_id = workresumption.agent_id;
                app.reason = workresumption.reason;
                app.leave_date = workresumption.leave_date;
                app.leave_time = workresumption.leave_time;
                app.return_time = workresumption.return_time;
                

                // this.cost = workresumption.cost;
                $('#leave_date').data('daterangepicker').setStartDate(reFormatDateTime(workresumption.leave_date));
                $('#leave_date').data('daterangepicker').setEndDate(reFormatDateTime(workresumption.leave_date));

   

                $('#agents').selectpicker('val', workresumption.agent_id);

                $('#reasons').selectpicker('val', workresumption.reason);
         
                

                

                // this.transportation = workresumption.transportation;


                if (app.reason == 'RS') {
                    app.details = workresumption.details;
            ...
            add_workresumption() {
                ...
                axios.post('/workresumptions', formData,
                        //  {
                        //         headers: {
                    ...
                    .then(function (response) {
                        ...
                        $('#workresumption-modal').modal('hide');
            ...
            update_workresumption() {
                var app = this;

                // app.operation = 'edit';
                // app.modal_title = "Modi une workresumption";
                ...
                // formData.append('report_scan', app.report_scan);
                axios.put('/workresumptions/' + app.selectedworkresumptionId, {
