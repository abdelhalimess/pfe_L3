...
Route::get('/getServices', [ServiceController::class, 'getServices'])->name('geServices');
...
Route::get('/getQuestions/{id}', [UserController::class, 'getQuestions'])->name('getQuestions');
...
Route::get('/getQuestionDocuments/{id}', [QuestionController::class, 'getQuestionDocuments'])->name('getQuestionDocuments');
Route::get('/getDocuments', [QuestionController::class, 'getDocuments'])->name('getDocuments');
...
Route::post('/getAvailableHours', [AppointmentController::class, 'getAvailableHours'])->name('getAvailableHours');
